...
<div class="fd-background d-flex justify-content-center align-items-center">
    <div class="card p-4" style="width: 100%; max-width: 700px;">
        <h3 class="text-center mb-4">Form Data Diri</h3>
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="" name="nama_lengkap" required placeholder="Masukkan Nama Lengkap">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="text" class="form-control" id="" name="email" required placeholder="Masukkan Email">
            </div>
            <div class="mb-3">
                <label for="nomor_telepon" class="form-label">Nomor Telepon</label>
                <input type="text" class="form-control" id="" name="nomor_telepon" required placeholder="Masukkan Nomor Telepon">
            </div>
            <div class="mb-3">
                <label for="alamat_lengkap" class="form-label">Alamat Lengkap</label>
                <input type="text" class="form-control" id="" name="alamat_lengkap" required placeholder="Masukkan Alamat Lengkap">
            </div>
            <div class="mb-3">
                <label for="identitas" class="form-label">Identitas Diri (KTP/SIM/Paspor)</label>
                <input type="file" class="form-control" id="" name="identitas" required placeholder="Identitas Diri (KTP/SIM/Paspor)">
            </div>
            <div class="mb-3">
                <label for="deskripsi_singakat" class="form-label">Deskripsi Singkagt Tentang Anda</label>
                <input type="text" class="form-control" id="" name="deskripsi_singakat" required placeholder="Deskripsi Singkagt Tentang Anda" style="height: 100px;">
            </div>
