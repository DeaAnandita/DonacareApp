...
<div class="fd-background d-flex justify-content-center align-items-center">
    <div class="card p-4" style="width: 100%; max-width: 700px;">
        <h3 class="text-center mb-4">Form Judul Galang Dana</h3>
        <p style="margin-top: -20px; margin-bottom: 25px; color: grey; text-align: center;">Isilah data diri dibawah dengan benar!</p>
        <form method="post">
            <div class="mb-3">
                <label for="judul" class="form-label">Judul Kampanye Penggalangan Dana</label>
                <input type="text" class="form-control" id="" name="judul" required placeholder="Judul Kampanye Penggalangan Dana">
            </div>
