...
<div class="fd-background d-flex justify-content-center align-items-center">
    <div class="card p-4" style="width: 100%; max-width: 700px;">
        <h3 class="text-center mb-4">Form Lengkapi Deskripsi</h3>
        <p style="margin-top: -20px; margin-bottom: 25px; color: grey; text-align: center;">Isilah data diri dibawah dengan benar!</p>
        <form method="post">
            <div class="mb-3">
                <label for="deskripsi" class="form-label">Deskripsi Lengkap Kampanye</label>
                <input type="text" class="form-control" id="" name="deskripsi" required placeholder="Deskripsi Lengkap Kampanye">
            </div>
            <div class="mb-3">
                <label for="dokumen" class="form-label">Dokumen Atau Foto Pendukung</label>
                <input type="text" class="form-control" id="" name="dokumen" required placeholder="Dokumen Atau Foto Pendukung">
            </div>
            <div class="mb-3">
                <label for="pesan" class="form-label">Pesan Untuk Para Donatur</label>
                <input type="text" class="form-control" id="" name="pesan" required placeholder="Pesan Untuk Para Donatur">
            </div>
            <button type="submit" class="btn btn-primary w-100" onclick="window.location.href='../step_galang.php'">Kirim</button>
        </form>
    </div>
</div>
